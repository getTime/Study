...
import com.kidney_hospital.base.util.DensityUtils;
import com.yyx.study.R;
import com.yyx.study.util.UIUtils;
...
public class CloudEditText extends EditText {
    ...
    private void init() {
        ...
        drawablePadding = DensityUtils.dp2px(10);
        itemPadding = DensityUtils.dp2px(3);
